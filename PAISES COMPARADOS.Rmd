...
```
```{r}
Comparacion[Comparacion$clustDIV==1 & Comparacion$Group=="1",'Country']
```
```{r}
Comparacion[Comparacion$clustDIV==2 & Comparacion$Group=="2",'Country']
```
```{r}
Comparacion[Comparacion$clustDIV==3 & Comparacion$Group=="3",'Country']
```
```{r}
Comparacion[Comparacion$clustDIV==4 & Comparacion$Group=="4",'Country']
```
```{r}
Comparacion[Comparacion$clustDIV==5 & Comparacion$Group=="5",'Country']
```

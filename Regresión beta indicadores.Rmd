...
```
```{r}
Mergeindicadores$PoliticaParticipacion=Mergeindicadores$PoliticaParticipacion/100
Mergeindicadores$Alfabetismo=Mergeindicadores$Alfabetismo/100
Mergeindicadores$Trabajos=Mergeindicadores$Trabajos/100
Mergeindicadores$TrabajosAgri=Mergeindicadores$TrabajosAgri/100

```
```{r}
Mergeindicadores$PoliticaParticipacion=str_extract_all(Mergeindicadores$PoliticaParticipacion,"\\d+\\.*\\d*")
Mergeindicadores$PoliticaParticipacion=as.numeric(Mergeindicadores$PoliticaParticipacion)
Mergeindicadores$Alfabetismo=str_extract_all(Mergeindicadores$Alfabetismo,"\\d+\\.*\\d*")
Mergeindicadores$Alfabetismo=as.numeric(Mergeindicadores$Alfabetismo)
...
#VCs:población
sub2=c('PoliticaParticipacion','Alfabetismo', 'Matrimonio15_19', 'TrabajosAgri', 'Unemploymentrate', 'Trabajos')
reg2Data=Mergeindicadores[,sub2]
modelBeta=betareg(Alfabetismo~.,data=reg2Data)
summary(modelBeta)
```
